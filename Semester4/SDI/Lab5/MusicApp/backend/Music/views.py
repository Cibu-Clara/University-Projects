...
from backend.Music.models import Song, Artist, Album, PerformsOn
from backend.Music.serializer import SongSerializer, ArtistSerializer, AlbumSerializer, AlbumSerializerID, \
