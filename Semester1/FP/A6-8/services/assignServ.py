...
class AssignmentService:
    def __init__(self, undo_serv):
        ...
        self.__stud_serv = StudentService(UndoServ)
        self.__grade_serv = GradeService(self.__stud_serv.student_list(), self.assignment_list(), UndoServ)
...
class AssignmentServicesTest(unittest.TestCase):
    def setUp(self):
        ...
        :return: None
        """
        self._serv = StudentService(UndoServ)
        self._repo = AssignmentService(UndoServ)
