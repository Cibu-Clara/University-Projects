...
public class ReadFile implements iStatement{
    ...
    public MyIDictionary<String, Type> typeCheck(MyIDictionary<String, Type> typeEnv) throws InterpreterException {
        if (expression.typeCheck(typeEnv).equals(new StringType()))
            ...
            throw new InterpreterException("ReadFile requires a String as its expression parameter.");
    }
            ...
            if (value.getType().equals(new IntType())) {
                ...
                if (result.getType().equals(new StringType())){
                    ...
                    try {
                        ...
                        throw new InterpreterException(String.format("The file table doesn't contain the file %s.", castValue));
                    }
                }
                else {
                ...
                throw new InterpreterException(String.format("Variable %s is not an integer.", value));
            }
        }
        else {
            throw new InterpreterException(String.format("Variable %s is not defined in the SymbolTable.", varName));
        }
        return null;
    }
