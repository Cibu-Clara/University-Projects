...
public class ProgramState {
    ...
    public ProgramState(MyIStack<iStatement> stack, MyIDictionary<String,Value> symTable, MyIList<Value> out, MyIDictionary<String, BufferedReader> fileTable, MyIHeap heapTable, MyIBarrier barrierTable, iStatement program) {
        this.exeStack = stack;
    ...
    public ProgramState(MyIStack<iStatement> stack, MyIDictionary<String,Value> symTable, MyIList<Value> out, MyIDictionary<String, BufferedReader> fileTable, MyIHeap heapTable, MyIBarrier barrierTable) {
        this.exeStack = stack;
        this.symTable = symTable;
        this.out = out;
        this.fileTable = fileTable;
    ...
    public MyIBarrier getBarrierTable() { return barrierTable; }
    ...
    public void setBarrierTable(MyIBarrier newBarrierTable) {
